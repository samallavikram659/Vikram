"""
=============================================================================
NEAR HIGH + OLIVER KELL COMBINED BACKTEST -- SAME-DAY CLOSE ENTRY (Yahoo Finance)
=============================================================================
...
def performance_report(
    ...
    label: str = "NEAR HIGH + OLIVER KELL -- SAME-DAY CLOSE ENTRY BACKTEST",
):
    sep = "=" * 70
    print(f"\n{sep}")
    print(f"  {label}")
...
def run_backtest(
    ...
    print("\n" + "=" * 70)
    print("  NEAR HIGH + OLIVER KELL -- SAME-DAY CLOSE ENTRY BACKTEST")
    ...
    performance_report(
        trades_df,
        equity_curve_df,
        label="NEAR HIGH + OLIVER KELL -- SAME-DAY CLOSE ENTRY BACKTEST",
    )

    # Save results
    ts  = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
    out_trades = f"near_high_oliver_sameday_trades_{ts}.csv"
    trades_df.to_csv(out_trades, index=False)
    print(f"  Trades saved to: {out_trades}")

    out_equity = f"near_high_oliver_sameday_equity_{ts}.csv"
